...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        if (l1.next is None) and (l2.next is None):
            if carryover == 1:
                return_list = ListNode(value, ListNode(1))
            else:
        ...
        # Need more recursion
            ...
            if l1.next is None:
                ...
                # Recurse!
                return_list = ListNode(value, Solution.addTwoNumbers(self, l1_next, l2.next))
            ...
            # Right side empty
                ...
                # Recurse!
                return_list = ListNode(value, Solution.addTwoNumbers(self, l1.next, l2_next))
...
if __name__ == "__main__":
    ...
    answer = runSolution.addTwoNumbers(l1, l2)
    assert answer.val == 7
    answer = answer.next
    assert answer.val == 9
    answer = answer.next
